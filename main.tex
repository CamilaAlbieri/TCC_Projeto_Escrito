...
\documentclass[
    ...
    brazilian,          % o último idioma é o principal do documento (ALTERADO DE BRAZIL PARA BRAZILIAN)
]{abntex2}
...
\usepackage{booktabs}
\usepackage{makecell}
\usepackage{tabularx}   % Para aceitar o ambiente tabularx
\usepackage{placeins}   % Para aceitar o comando \FloatBarrier
% ---
...
% Configurações para eliminar avisos de glue shrinkage em longtable
\setlength{\LTpre}{0pt}
\setlength{\LTpost}{0pt}
\setlength{\parskip}{0pt}
\raggedbottom % Permite páginas com altura variável
\setlength{\extrarowheight}{2pt} % Espaço extra nas linhas
...
\titulo{Plataforma Personalizável para Criação e Compartilhamento de Coleções Digitais}
...
\autor{Camila Albieri Mattos}
\orientador{Dra. Helen de Freitas Santos}
...
% Páginas exclusivas de flutuantes começam no topo, em vez de centralizadas
\makeatletter
\setlength{\@fptop}{0pt}
\makeatother
...
\selectlanguage{brazilian} % <--- ALTERADO DE BRAZIL PARA BRAZILIAN
...
%\input{elementos-pre/pre02FolhaDeRosto}
% ---

% ---
% Inserir a ficha catalográfica
% ---
%\input{elementos-pre/pre03FichaCatalografica}

% ---
% Inserir a ERRATA
% ---
%\input{elementos-pre/pre12Errata}

% ---
% Inserir folha de aprovação
% ---
%\input{elementos-pre/pre04FolhaDeAprovacao}

% ---
% Dedicatória
% ---
%\input{elementos-pre/pre05Dedicatoria}

% ---
% Agradecimentos
% ---
%\input{elementos-pre/pre06Agradecimentos}

% ---
% Epígrafe
% ---
%\input{elementos-pre/pre07Epigrafe}

% ---
% Resumos
% ---
%\input{elementos-pre/pre08Resumo}
%\input{elementos-pre/pre09Abstract}
...
% ---
%\input{elementos-pre/pre10ListaSiglas}
% ---

% ---
% inserir lista de símbolos
% ---
%\input{elementos-pre/pre11ListaSimbolos}
% ---
...
% ATUALIZADO PARA A PASTA capitulos/
%\input{capitulos/capitulo01Introducao}
%\input{capitulos/capitulo02RevisaoLiteratura}
\input{capitulos/capitulo03MateriaisEMetodos}
\input{capitulos/capitulo04DescricaoGeraldoProduto}
\input{capitulos/capitulo05ElicitacaodeRequisitosEAnalise}
\input{capitulos/capitulo06ProjetodeSoftware}
\input{capitulos/capitulo07Implementacao}
\input{capitulos/capitulo08Teste}
%\input{capitulos/capitulo09Implantacao}
%\input{capitulos/capitulo10ResultadosDiscussao}
%\input{capitulos/capitulo11TrabalhosRelacionados}
%\input{capitulos/capitulo12Conclusoes}
%\input{capitulos/capitulo13Cronograma}
...
% ----------------------------------------------------------
% Mantido na raiz por enquanto. Se mover o arquivo .bib, altere aqui.
...
% Apêndices
% ----------------------------------------------------------
% ATUALIZADO PARA A PASTA elementos-pos/
%\input{elementos-pos/pos01Apendices}
...
% ----------------------------------------------------------
% ATUALIZADO PARA A PASTA elementos-pos/
% \input{elementos-pos/pos02Anexos}
