...
\begin{itemize}
    ...
    \item \textbf{Relações N:N:} Implementadas via tabelas associativas (como \texttt{element\_values} e \texttt{collection\_follows}), protegidas por chaves únicas compostas que impedem a duplicação de pares;
...
\caption{Tabelas Identificadas neste Trabalho}
    \begin{tabularx}{\textwidth}{ | l | X | }
        ...
        element\_values & Tabela~\ref{tab:tabelaValorElementoDetalhado} \\ \hline
...
\begin{tabularx}{\textwidth}{ | X | c | c | c | c | c | c | c | }
    ...
    font\_size & Float &  &  &  &  &  &  \\ \hline
    font\_weight & Varch.(20) &  &  &  &  &  &  \\ \hline
    text\_align & Varch.(20) &  &  &  &  &  &  \\ \hline
    color & Varch.(9) &  &  &  &  &  &  \\ \hline
    background\_color & Varch.(9) &  &  &  &  &  &  \\ \hline
...
\begin{table}[!htbp]
\centering
\caption{Valores dos Elementos (element\_values)}
\footnotesize
\begin{tabularx}{\textwidth}{ | X | c | c | c | c | c | c | c | }
    \hline
    \textbf{Campo} & \textbf{Tipo} & \textbf{Obr.?} & \textbf{PK?} & \textbf{Tab.} & \textbf{Cmp.} & \textbf{Grp.} & \textbf{Ord.}\\ \hline
    id\_element\_value & UUID & X & X &  &  &  &  \\ \hline
    value & Text & X &  &  &  &  &  \\ \hline
    pos\_x & Int &  &  &  &  &  &  \\ \hline
    pos\_y & Int &  &  &  &  &  &  \\ \hline
    ...
    element\_id & UUID & X &  & elements & id\_element & UK\_01 & 2 \\ \hline
\end{tabularx}
\vspace{0.1cm} \\ \textbf{Fonte:} Elaborada pelo autor
\label{tab:tabelaValorElementoDetalhado}
\end{table}
