...
\begin{itemize}
    ...
    \item \textbf{Relações N:N:} Implementadas via tabelas associativas (como \texttt{item\_widgets} e \texttt{collection\_follows}), protegidas por chaves únicas compostas que impedem a duplicação de pares;
    \item \textbf{Relações Reflexivas:} As interações sociais (amizades) são mapeadas como relações nomeadas para distinguir os papéis de remetente e destinatário, com chave única composta sobre os identificadores envolvidos;
...
Para melhor compreensão da arquitetura de dados, as 12 tabelas propostas neste trabalho estão consolidadas na Tabela~\ref{tab:tabelasIdentificadas}, que serve como índice para o detalhamento físico apresentado na subseção seguinte.
...
\begin{table}[!htbp]
    ...
    \begin{tabularx}{\textwidth}{|X|c|c|c|c|c|c|c|}
        ...
        email & Varch.(255) & X & & & & UK\_01 & 1 \\ \hline
...
\begin{tabularx}{\textwidth}{ | X | c | c | c | c | c | c | c | }
    ...
    palette\_name & Varch.(100) & X &  &  &  &  &  \\ \hline
...
\begin{tabularx}{\textwidth}{ | X | c | c | c | c | c | c | c | }
    ...
    pos\_x & Int &  &  &  &  &  &  \\ \hline
    pos\_y & Int &  &  &  &  &  &  \\ \hline
    width & Varch.(20) &  &  &  &  &  &  \\ \hline
    height & Varch.(20) &  &  &  &  &  &  \\ \hline
    item\_id & UUID & X &  & items & id\_item & UK\_01 & 1 \\ \hline
    widget\_id & UUID & X &  & widgets & id\_widget & UK\_01 & 2 \\ \hline
\end{tabularx}
\vspace{0.1cm} \\ \textbf{Fonte:} Elaborada pelo autor
...
\begin{tabularx}{\textwidth}{ | X | c | c | c | c | c | c | c | }
    ...
    sender\_id & UUID & X &  & users & id\_user & UK\_01 & 1 \\ \hline
    receiver\_id & UUID & X &  & users & id\_user & UK\_01 & 2 \\ \hline
\end{tabularx}
\vspace{0.1cm} \\ \textbf{Fonte:} Elaborada pelo autor
