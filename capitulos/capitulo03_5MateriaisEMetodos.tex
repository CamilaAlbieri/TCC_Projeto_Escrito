...
Diante da quantidade de entidades identificadas, adotou-se a organização do diagrama em seis pacotes conceituais --- Usuário, Coleções, Editor de Layout, Interação Social, Notificação e Aparência. Esse agrupamento, além de reduzir a sobrecarga visual do diagrama, evidencia a separação de responsabilidades que seria posteriormente materializada na estrutura modular do \textit{backend} implementado com NestJS.
